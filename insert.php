...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email) value('$fname','$lname', '$contno', '$email' )");
    if ($query) {
...
<div class="signup-form">
    <form  method="POST">
		<h2>Fill Data</h2>
		<p class="hint-text">Add A New Friend</p>
	...
	<div class="text-center">Click Here to See List:  <a href="index.php">CLICK</a></div>
</div>
</body>
</html>