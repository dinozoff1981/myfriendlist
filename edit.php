...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname', MobileNumber='$contno', Email='$email' where ID='$eid'");
...
?>
		<h2>Update </h2>
		<p class="hint-text">Edit A Friend</p>
